...
/**
 * Servlet implementation class ManagerAllfileSelectCtrl
 */
@WebServlet("/selectService")
public class ManagerAllfileSelectCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerAllfileSelectCtrl() {
        super();
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try { 
			// 총 글 개수
			int pCount = fileService.getBoardCount();
			...
			List<ManagerAllfileVO> list = ManagerAllfileSrv.allList(startRnum, endRnum);
			...
			request.getRequestDispatcher("/allfile/allfileBoard.jsp").forward(request, response);
