 ...
 */
@WebServlet("/ManagerPostListCtrl")
public class ManagerPostListCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerPostListCtrl() {
        super();
	...
	protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try { 
			...
			List<ManagerPostVo> list = ManagerPostSrv.postList(startRnum, endRnum);
			...
			request.getRequestDispatcher("/post/pList.jsp").forward(request, response);
