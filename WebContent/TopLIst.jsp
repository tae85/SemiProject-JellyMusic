    ...
    <style>
        ...
        [class*="top-"] {
            ...
            text-transform: uppercase;
             ...
             [class*="top-"]::after, [class*="top-"]::before {
                 content: "";
                 position: absolute;
                 }
                 [class*="top-"]:hover, [class*="top-"]:focus {
                     background: rgba(255, 255, 255, 0.8);
                     }
                     [class*="top-all"]::after {
                         background: rgb(23, 26, 40);
                         border-radius: 120px;
                     ...
                     [class*="top-all"]::before {
                        background: transparent;
                         border-radius: 100%;
                         top: 50%;
                         left: 50%;
                         box-shadow: 0 1em 2em 3em rgb(74, 254, 0), 4em 0em 2em 2em rgba(131, 211, 85, 0.6), -4em -2em 2em 2em rgba(78, 199, 78, 0.5), -4em 2em 2em 4em rgba(48, 172, 95, 0.5), 0 -3em 2em 3em rgba(120, 250, 0, 0.5), 2em -1em 2em 2em rgba(89, 53, 223, 0.5);
                         width: 0;
                         height: 0;
                    ...
                    @-webkit-keyframes all {
                         30% {
                         box-shadow: 0 -1em 2em 3em rgba(52, 175, 58, 0.5), 4em -1em 2em 3em rgba(131, 211, 85, 0.6), -4em 2em 3em 2em rgba(155, 200, 0, 0.5), -4em -2em 2em 2em rgba(30, 156, 37, 0.5), 0 3em 2em 2em rgba(20, 250, 0, 0.5), 2em 1em 2em 2em rgba(50, 10, 250, 0.5);
                    }
                         60% {
                        box-shadow: 2em 1em 2em 3em rgba(120, 84, 211, 0.5), 3em 1em 2em 3em rgba(42, 179, 14, 0.6), 3em -2em 3em 3em rgba(155, 200, 0, 0.5), -4em 2em 2em 3em rgba(105, 148, 79, 0.6), 0 -3em 2em 3em rgba(200, 250, 0, 0.5), -2em 1em 2em 3em rgba(50, 210, 250, 0.6);
                    }
                    }
                    @keyframes all {
                         30% {
                         box-shadow: 0 -1em 2em 3em rgb(74, 254, 0), 4em -1em 2em 3em  rgba(131, 211, 85, 0.6), -4em 2em 3em 2em rgba(155, 200, 0, 0.5), -4em -2em 2em 2em rgba(121, 77, 231, 0.5), 0 3em 2em 2em rgba(20, 250, 0, 0.5), 2em 1em 2em 2em rgba(50, 10, 250, 0.5);
                    }
                         60% {
                         box-shadow: 2em 1em 2em 3em rgba(120, 84, 211, 0.5), 3em 1em 2em 3em rgba(39, 172, 13, 0.6), 3em -2em 3em 3em rgba(155, 200, 0, 0.5), -4em 2em 2em 3em rgba(137, 105, 216, 0.5), 0 -3em 2em 3em rgba(200, 250, 0, 0.5), -2em 1em 2em 3em rgba(139, 138, 235, 0.6);
                             }
                             }
        .top-all-play::after {
       ...
       .top_wrap_btn_tb .top_button_rbox{
            float: left;
            padding: 0 9px;
            margin-left: 10px;
        }
        ...
        .top_button_icons_play{
            width: 16px;
            height: 28px;
            background-position: 0 -30px;
        }
        .top_button_icons_scrap{
            width: 19px;
            height: 28px;
            background-position: -45px -30px;
        }
        .top_button_icons_download{
            width: 21px;
            height: 24px;
        ...
        <div id="top_content" class="top_content">
            <h1 class="top_title"><img src="${pageContext.request.contextPath}/image/jelly-beans.svg" id="top_img">Top100</h1>
            <div class="top_ontion_area">
                <div class="top_area_inner">
                    <div class="top_play_option">
                        <span class="top_inner_option">
                            <a href="#" role="button" class="top-all-play" data-text="All play">All play</a>
                        </span>
                        <span class="top_inner_option">
                            <a href="#" role="button" class="top-all-shuffle" data-text="Random play">Random play</a>
                        </span>
                    </div>
                </div>
                <div class="top_control_area">
                </div>
                <div class="top_wrap_btn_tb">
                    <button type="button" title="선택된 곡 듣기" class="top_button_rcox" onclick="">
                        <span class="top_botton_icons"></span>
                        <span class="cnt">듣기</span>
                    </button>
                    <button type="button" title="선택된 곡 담기" class="top_button_rcox" onclick="">
                        <span class="top_button_icons"></span>
                ...
                <tbody>
                    ...
                    <c:forEach items="${TopList}" var="v" varStatus="s">
                    <tr>
                        <td>
                            <div class="top_wrap_t1">
                                <input type="checkbox" title="곡선택" class="top_input_check" name="top_input_check" value="">
                            </div>
                        </td>
                        <td>
                        <div class="top_wrap">${s.count }</div>
                        </td>
                        <td>
                            <div class="top_wrap">
                                <a href="#" class="top_image_all">
                                    <img onerror="" src="#" width="60" height="60">
                                    <span class="top_album_frame"></span>
                                </a>
                            </div> 
                        <td>
                            <div class="top_wrap">                             
                                    <div class="top_art_name">
                                        <a href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}" >${v.art_no}</a>
                                    </div>
                            </div>
                        </td>
                        <td>
                            <div class="top_wrap">
                                <div class="top_music_name">
                                    <a href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}">${v.mu_name}</a>
                                </div>
                            </div>
                        </td>
                        <td class="top_wrap">
                            <a href="#" class="top_button_like">
                                <img src="#" class="top_odd_span">좋아요
                                    <a href="<%=request.getContextPath() %>/#?mu_every_heart=${v.mu_every_heart}" class="top_none">${v.mu_every_heart}</a>          
                            </a>
                        </td>
                        <td>
                            <div class="top_wrap_center">
                                <button type="button" title="듣기" class="top_button_icons_play" onclick="">
                                    <span class="top_none">듣기</span>
                                </button>
                                <a href="<%=request.getContextPath()%>/playerCtrl.do?mu_no=${v.mu_no}" onclick="window.open(this.href,'','width=1200,height=720,scrollbars=no'); return false;" class="top_button_icons_play">
            ...
            <script>
                $(".top_button_icons_play").click(function() {
