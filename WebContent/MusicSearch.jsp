...
.M_art_song_section {
	position: relative;
	padding: 18px 0;
	border-top: 1px solid #ededed23;
}

.M_song_track_section {
	padding: 5px 0 32px;
}
...
.M_track_list .thumb .thumb_inner {
	position: relative;
	width: 40px;
	height: 40px;
}
...
.M_sch_album_wrap>div {
	height: 100%;
}

.M_sch_album_wrap>div>ul {
	padding: 0 100px;
}
...
.M_lyrics_track_wrap {
	padding-bottom: 19px;
	border-bottom: 1px solid #ededed23;
}
...
<body>
	...
	<div id="M_sch_container" class="M_sch_container">
		<div id="M_sch_content" class="M_sch_content">
			<div class="M_search_artist">
				<div class="M_search_artist02">
					<div class="M_sch_art_header">
						<h1 class="M_sch_art_title">Artists</h1>
					</div>
				</div>
			</div>
			<div class="M_sch_art_list">
				<div>
					<ul>
					<c:if test="${not empty artist }">
							<c:forEach items="${artist }" var="v" varStatus="s">
						<li class="M_art_item">
							<div class="M_art_item_area">
								<a href="#" class="M_item_link"> <img src="#" class="M_art_img">
								</a>
								<div class="M_art_item_info">
									<a href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}" class="M_info_title_link">${v.art_name}</a>
								</div>
							</div>
						</li>
						<li class="M_art_item">
						...
						<li class="M_art_item">
							<div class="M_art_item_area">
								<a href="#" class="item_link"> <img src="#" class="art_img">
								</a>
								<div class="M_art_item_info">
									<a href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}" class="M_info_title_link">${v.art_name}</a>
								</div>
			...
			<div class="M_art_song_section">
				<div class="M_sch_art_header">
					<h2 class="M_sch_art_title">Song</h2>
				</div>
				<div class="M_song_track_section">
					<div>
						<div class="M_track_list">
							<table>
								<thead>
									<tr>
										<th scope="col" class="M_thumb"></th>
										<th scope="col" class="M_song"></th>
										<th scope="col" class="M_artist"></th>
										<th scope="col" class="M_album"></th>
										<th scope="col" class="M_lyrics"></th>
									</tr>
								</thead>
								<tbody>
								<c:if test="${not empty song }">
							<c:forEach items="${song }" var="v" varStatus="s">
									<tr>
										<td class="M_thumb">
											<div class="M_thumb_inner">
												<img src="#" class="M_thumb_img">
												<!-- <a href="#" class="icon_play" ></a> -->
											</div>
										</td>
										<td class="M_song">
											<div class="M_song_title">
												<a
													href="<%=request.getContextPath() %>/albumMoreServlet?al_no=${v.al_no}"
													class="M_title_link">${v.al_name}</a>
											</div>
										</td>
										<td class="M_artist">
											<div class="M_artist_title">
												<a
													href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}"
													class="M_artist_link">${v.art_name}</a>
											</div>
										</td>
										<td class="M_album"><a
											href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}"
											class="M_album_link">${v.mu_name}</a></td>
										<td class="M_lyrics"><a href="#" type="button"
											class="M_btn_lyrics"><img src="<%=ctxPath %>/image/fileinterfacesymboloftextpapersheet_79740.svg" class="M_muly_img"></a></td>
									</tr>
									<tr>
										<td class="M_thumb">
											<div class="M_thumb_inner">
										...
										<td class="M_song">
											<div class="M_song_title">
												<a href="<%=request.getContextPath() %>/albumMoreServlet?mu_no=${v.al_no}" class="M_title_link">${v.al_name}</a>
											</div>
										</td>
										<td class="M_artist">
											<div class="M_artist_title">
												<a href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}"  class="M_artist_link">${v.art_no}</a>
											</div>
										</td>
										<td class="M_album"><a href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}" class="M_album_link">${v.mu_name}</a>
										</td>
									</tr>
								<tr>
										<td class="M_thumb">
			...
			<div class="M_art_album_section">
				<div class="M_sch_art_header">
					<h2 class="M_sch_art_title">Album</h2>
				</div>
				<div class="M_sch_album_wrap">
					<div>
						<ul>
						<c:if test="${not empty album }">
							<c:forEach items="${album }" var="v" varStatus="s">
							<li class="M_album_list">
								<div class="M_album_area">
									<a href="#" class="M_album_list_area"> <img src="#"
										class="M_album_list_img">
									</a>
								</div>
								<div class="M_info">
									<a href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}" class="M_alb_title">{v.mu_name}</a>
									<div class="M_alb_artist">${v.art_name}</div>
								</div>
							</li>
							<li class="M_album_list">
								<div class="M_album_area">
				...
				<div class="M_art_lyrics_section">
					<div class="M_sch_lyrics_header">
						<h2 class="M_sch_lyrics_title">Lyrics</h2>
					</div>
					<div class="M_lyrics_track">
						<div class="M_lyrics_track_wrap">
							<div class="M_track_row">
								<div class="M_thumb">
									<img src="#" class="M_thumb_img">
								</div>
								<div class="M_info_area">
									<div class=M_title">
										<a href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}" class="M_lyrics_link">${v.mu_name}</a>
										<div class="M_artist">
											<a href="<%=request.getContextPath() %>/artistMoreServlet?art_no=${v.art_no}" class="M_ly_art_link">${v.art_name}</a>
										</div>
										<p class="M_lyrics_row">
											<span class="M_blind">가사</span> <span>${v.mu_ly}</span>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="M_track_row">
								...
								<div class="M_info_area">
									<div class="M_title">
										<a href="<%=request.getContextPath() %>/musicMoreServlet?mu_no=${v.mu_no}" class="M_lyrics_link">${v.mu_name}</a>
										<div class="M_artist">
											<a href="#" class="M_ly_art_link">${v.art_name}</a>
										</div>
										<p class="M_lyrics_row">
											<span class="M_blind">가사</span> <span>${v.mu_ly}</span>
										</p>
