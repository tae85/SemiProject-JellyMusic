...
<body> <nav id="fix_side">
    ...
    <header class="fix_header">
    	...
    	<form id="frm">
		<input type=hidden name="ms_no" id="ms_no"value="<%=request.getParameter("no")%>">
		<input type="button" value="구매완료" onclick="goSubmit();">
	</form>
	</div>
	</div>
      ...
      function goSubmit(){
         ...
         if($("#ms_no").val() == '2') {
            $.ajax({
               ...
               data: { ms_no : '<%=request.getParameter("no")%>' },
